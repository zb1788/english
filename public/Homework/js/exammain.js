...
require(['jquery','mui',"mobile","touchslide","view","setContent"], function($,mui,mobile,touchslide,view,hw){
    //进行时间的展示
    ...
    mui.back=function(){
      ...
      }else if(issubmit==1&&type=="2"){
        mui.openWindow('finish?homeworkid='+homeworkid+'&batchid='+batchid+'&studentid='+studentid+'&classid='+classid+"&type=2");
      }else{
