...
function setQuestionContent(data){
	...
	if(data.parent.question.typeid=="1"||data.parent.question.typeid=="0"){
		...
		if(data.parent.question.typeid==0){
			questionhtml=questionhtml+'<div class="lanren" id="lanren" style="text-align:center;" mp3="'+data.parent.question.mp3+'"><div style="width:98%;margin-left:auto;margin-right:auto;padding-top:10px;"><span class="sy-left"><img src="data:image/png;base64," height="40px;"></span><a class="edi-sy audio-btn" id="audio-btn" quesid="'+data.parent.question.id+'"  mp3="'+data.parent.question.mp3+'" type="0"><img class="sy-click" id="sy-click" src="data:image/png;base64," height="40px;"></a><div class="loading" style="display:none;"></div><span class="sy-right"><img src="data:image/png;base64," height="40px;"></span></div></div>';
		}else{
			data.parent.question.tcontent=data.parent.question.tcontent.replace('/uploads',resource+'/uploads');
		...
		if(issubmit=='1'){
			...
			questionhtml=questionhtml+'<h5>作答情况</h5>';
			questionhtml=questionhtml+'<ul id="list" class="mui-table-view mui-table-view-chevron" style="margin-top: 10px;">';
			mui.each(data.parent.summary,function(k,v){
				questionhtml=questionhtml+'<li class="mui-table-view-cell mui-collapse">';
				questionhtml=questionhtml+'<a class="mui-navigate-right" href="#">'+k+'.作答人数'+parseInt((parseInt(v)*parseInt(data.parent.answer[0].summary.answernum))/100)+'人，占比'+v+'%</a>';
				questionhtml=questionhtml+'<ul class="mui-table-view mui-table-view-chevron">';
				questionhtml=questionhtml+'<li class="mui-table-view-cell">';
				questionhtml=questionhtml+'<button type="button" class="mui-btn mui-btn-danger" style="margin-top: 10px;margin-left: 10px;float:left;">红色</button>';
				questionhtml=questionhtml+'<button type="button" class="mui-btn mui-btn-danger" style="margin-top: 10px;margin-left: 10px;float:left;">红色</button>';
				questionhtml=questionhtml+'<button type="button" class="mui-btn mui-btn-danger" style="margin-top: 10px;margin-left: 10px;float:left;">红色</button>';
				questionhtml=questionhtml+'<button type="button" class="mui-btn mui-btn-danger" style="margin-top: 10px;margin-left: 10px;float:left;">红色</button>';
				questionhtml=questionhtml+'</li>';
				questionhtml=questionhtml+'</ul></li>';
			});
			questionhtml=questionhtml+'</ul>';
			questionhtml=questionhtml+'</div>';
	       ...
	       //进行单词的展示
			...
			mui.each(items,function(key,value){
				...
				if(ind>-1&&key<(items.length-1)){
					...
					questionhtml=questionhtml+'<li style="float:left;width:20%;"><a class="worditems items'+ind+' actived" quesid="'+data.parent.question.id+'" wordid="'+data.parent.question.wordid+'" typeid="2" homeworkid="'+data.parent.question.homeworkid+'" style="font-family: Muiicons;padding-left:5px;margin-left:0px;margin-top:10px;display:inline-block;padding: 0;width: 50px;height: 50px;border-radius: 20px;background-color: #2bc8a0;text-align: center;box-shadow: 0px 3px 8px #aaa, inset 0px 2px 3px #2bc8a0;border: solid 1px transparent;color: white;" style="background-color: rgb(239, 239, 244);"><span class="mui-icon" style="font-family: inherit;"><font style="font-family: Times New Roman;" >'+value+'</font></span></a></li>';
				}else if(key<(items.length-1)){
					questionhtml=questionhtml+'<li style="float:left;;width:20%;"><a style="font-family: Muiicons;padding-left:5px;margin-left:0px;margin-top:10px;display:inline-block;padding: 0;width: 50px;height: 50px;border-radius: 20px;  background-color: #f7f7f7;text-align: center;box-shadow: 0px 3px 8px #aaa, inset 0px 2px 3px #fff;border: solid 1px transparent;color: #a7a7a7;" class="worditems items" quesid="'+data.parent.question.id+'" wordid="'+data.parent.question.wordid+'" typeid="2" homeworkid="'+data.parent.question.homeworkid+'"><span class="mui-icon" style="font-family: inherit;"><font style="font-family: Times New Roman;" >'+value+'</font></span></a></li>';
				}
			});
			questionhtml=questionhtml+'<li style="float:left;;width:20%;"><a class="worddel" style="font-family: Muiicons;padding-left:0px;margin-left:0px;margin-top:10px;display:inline-block;padding: 0;width: 50px;height: 50px;border-radius: 20px;  background-color: #f7f7f7;text-align: center;box-shadow: 0px 3px 8px #aaa, inset 0px 2px 3px #fff;border: solid 1px transparent;color: #a7a7a7;" class="worditems items"  typeid="2" ><span class="mui-icon" style="font-family: inherit;"><i class="fa fa-arrow-left"></i></span></a></li>';
			questionhtml=questionhtml+'</ul></div></div>';
			//看是否提交数据
			if(issubmit=='1'){
				if(type=="0"){
	...
	mui.ajax(url,
		...
		success:function(data){
			...
			if(data.type==0){
				...
				}else if(data.parent.question.typeid==1||data.parent.question.typeid==3){
			...
			if(data.type==0||data.type==1){
				...
				content='<div class="parent" id="parent" style="margin-left:10px;margin-right: 10px;">';
				content=content+aloundContent(data[0],datatype);
				content=content+'</div>';
			}
			...
			if(issubmit==0&&isOverdue=='false'){
				if(data.type==1){
					...
					if(data.type==0){
						...
						if(data.parent.question.typeid=='2'){
							//删除按钮的样式进行修改
							mui('#item'+pageindex+' div.flex-container').on('tap',"li.worddel",function(e){
				...
				if(data.type==2||data.type==3){
					...
					// 	}else{
					// 		//alert(mp3);
					// 		mp.play("http://en.youjiaotong.com/yylmp3/recordwav/"+mp3);
					// 	}
					// });

					//用户听自己的音频
					mui("div.wordtest").on("click","p.mp3voice",function(){
						var mp3=this.getAttribute("mp3");
						if(mp3==''||mp3=='null'){
							mui.toast("请开始录音");
						}else{
							if(data.type==2){
								...
								mp.play(text_mp3_url+mp3.substr(0,2)+"/"+mp3+".mp3");
							}
						}
					});
				}
...
//预览页面的数据
//请求响应
function getPreviewRespose(url,errinfo,index,source,id,pageindex,type,typeid){
	var respose="";
	listendata=[];
	mui.ajax(url,
		{
		...
		success:function(data){
			...
			if(data.type==0){
				...
				if(data.parent.question.typeid==0){
					document.getElementById("type").innerHTML="听音选词";
				}else if(data.parent.question.typeid==1){
					document.getElementById("type").innerHTML="英汉互译";
				}else if(data.parent.question.typeid==2){
					document.getElementById("type").innerHTML="单词拼写";
				}
			...
			if(data.type==0||data.type==1){
				...
				content=aloundContent(data[0],data.type);
			}
			var muiindex="item"+pageindex;
			console.log(muiindex);
			document.getElementById(muiindex).innerHTML=content;
			page[pageindex]=1;
			if(data.type==1){
			...
			mui.each(objs,function(){
      	    ...
      	    if(data.type==1){
      	    	...
      	    	console.log(data);
      	    	//发声
      	    	if(data.parent.question.typeid=='0'||data.parent.question.typeid=='2'){
      	    		mui("div.lanren").on('tap','a.audio-btn',function(){
						var mp3=this.getAttribute("mp3");
						var obj=this;
						this.getElementsByClassName("sy-click")[0].src="../../public/Homework/images/sy.gif";
      	    	...
      	    	//教师预览进行单词的原因发音
  	    		document.getElementsByClassName("ques")[pageindex].getElementsByClassName("mp3voice")[0].addEventListener("click",function(){
  	    			var mp3=this.getAttribute("mp3");
					mp.play(word_mp3_url+mp3);
  	    		});
  	    		...
  	    		document.getElementsByClassName("ques")[pageindex].getElementsByClassName("mp3voice")[0].addEventListener("click",function(){
					var mp3=this.getAttribute("mp3");
					mp3  = text_mp3_url+mp3.substr(0,2)+'/'+mp3+'.mp3'
					mp.play(mp3);
  	    		});
      	    }
		},
				...
				mui.each(data.wc,function(k,v){
					...
					if(issubmit=='0'){
						...
						if(v.isdo!=''&&v.isdo!='null'&&v.iscorrect=='1'){
			        		...
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="examsquiz?index='+(wacount+wscount+k)+'"  class="quessummary" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
				...
				mui.each(data.wr,function(k,v){
					...
					if(issubmit=='0'){
						...
						if(v.isdo!=''&&v.isdo!='null'&&v.iscorrect=='1'){
			        		...
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="examsquiz?index='+(wacount+wscount+wccount+k)+'"  class="quessummary" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
				...
				mui.each(data.eq,function(k,v){
					...
					if(issubmit=='0'){
						...
						if(v.isdo!=''&&v.isdo!='null'&&v.score=='1'){
			        		...
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" class="quessummary" loc="examsquiz?index='+(wscount+wccount+wrcount+wacount+tacount+kindex-1)+'" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
...
//汇总页面的数据展示
function getPreviewSummaryData(){
		...
		success:function(data){
				...
				mui.each(data.wordalound,function(k,v){
					...
					if(issubmit=='0'){
						if(v.answer!=undefined&&v.answer!=''&&v.answer!='null'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+parseInt(k)+'" class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+parseInt(k)+'"  class="quessummary"><span class="mui-icon">'+i+'</span></a>';
			        	}
					}else{
						if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='1'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+parseInt(k)+'"  class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='0'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+parseInt(k)+'"  class="quessummary" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+parseInt(k)+'"  class="quessummary" style=""><span class="mui-icon">'+i+'</span></a>';
			        	}
					}
				});
			}
			if(data.wordspell.length>0){

				//服务器返回然后进行h5的本地存储
				summaryhtml=summaryhtml+"<p style='margin-top:20px;'>&nbsp;&nbsp;单词拼写<p>";
				mui.each(data.wordspell,function(k,v){
					wscount=wscount+1;
					i=(k+1);
					if(issubmit=='0'){
						if(v.answer!=undefined&&v.answer!=''&&v.answer!='null'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(k))+'" class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(k))+'"  class="quessummary"><span class="mui-icon">'+i+'</span></a>';
			        	}
					}else{
						if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='1'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(k))+'"  class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='0'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(k))+'"  class="quessummary" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(k))+'"  class="quessummary" style=""><span class="mui-icon">'+i+'</span></a>';
			        	}
					}
				});
			}
			if(data.wordchoose.length>0){

				//服务器返回然后进行h5的本地存储
				summaryhtml=summaryhtml+"<p style='margin-top:20px;'>&nbsp;&nbsp;听音选词<p>";
				mui.each(data.wordchoose,function(k,v){
					wccount=wccount+1;
					i=(k+1);
					if(issubmit=='0'){
						if(v.answer!=undefined&&v.answer!=''&&v.answer!='null'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(k))+'" class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(k))+'"  class="quessummary"><span class="mui-icon">'+i+'</span></a>';
			        	}
					}else{
						if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='1'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(k))+'"  class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='0'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(k))+'"  class="quessummary" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(k))+'"  class="quessummary" style=""><span class="mui-icon">'+i+'</span></a>';
			        	}
					}
				});
			}
			if(data.wordrate.length>0){

				//服务器返回然后进行h5的本地存储
				summaryhtml=summaryhtml+"<p style='margin-top:20px;'>&nbsp;&nbsp;英汉互译<p>";
				mui.each(data.wordrate,function(k,v){
					wrcount=wrcount+1;
					i=(k+1);
					if(issubmit=='0'){
						if(v.answer!=undefined&&v.answer!=''&&v.answer!='null'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(k))+'" class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(k))+'"  class="quessummary"><span class="mui-icon">'+i+'</span></a>';
			        	}
					}else{
						if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='1'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(k))+'"  class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='0'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(k))+'"  class="quessummary" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(k))+'"  class="quessummary" style=""><span class="mui-icon">'+i+'</span></a>';
			        	}
					}
				});
			}
			if(data.textalound.length>0){
				...
				mui.each(data.textalound,function(k,v){
					...
					if(issubmit=='0'){
						if(v.answer!=undefined&&v.answer!=''&&v.answer!='null'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(k))+'" class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(k))+'"  class="quessummary"><span class="mui-icon">'+i+'</span></a>';
			        	}
					}else{
						if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='1'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(k))+'"  class="quessummary" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='0'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(k))+'"  class="quessummary" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(k))+'"  class="quessummary" style=""><span class="mui-icon">'+i+'</span></a>';
			        	}
					}
				});
			}
				...
				mui.each(data.examsquiz,function(k,v){
					...
					if(issubmit=='0'){
						if(v.iscorrect=='1'||v.iscorrect=='0'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" class="quessummary" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(tacount)+parseInt(kindex)-1)+'" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" class="quessummary" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(tacount)+parseInt(kindex)-1)+'"><span class="mui-icon" style="colar:black">'+i+'</span></a>';
			        	}
					}else{
						if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='1'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" class="quessummary" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(tacount)+parseInt(kindex)-1)+'" style="background: rgb(43, 200, 160);"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        }else if(v.answer!=''&&v.answer!='null'&&v.iscorrect=='0'){
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" class="quessummary" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(tacount)+parseInt(kindex)-1)+'" style="background-color:darkgoldenrod;"><span class="mui-icon" style="color:white;">'+i+'</span></a>';
			        	}else{
			        		summaryhtml=summaryhtml+'<a id="icon-icon-contact" class="quessummary" loc="preview?index='+(parseInt(wacount)+parseInt(wscount)+parseInt(wccount)+parseInt(wrcount)+parseInt(tacount)+parseInt(kindex)-1)+'" style=""><span class="mui-icon" style="colar:black">'+i+'</span></a>';
			        	}
					}
				});
			}
...
//口语的样式
function aloundContent(data,type){
	var content="";
	content=content='<div class="parent" id="parent" style="margin-left:10px;margin-right: 10px;">';
	if(type==2){
		content=content+'<div class="title" style="margin-top:10px;font-size:1.2em;font-family: times;color:black;text-align:center;">';
		if(data.ukmark!=undefined&&data.ukmark!=""&&data.ukmark!='null'){
			content=content+'<h1 style="font-size:2.0em;color:black;">'+data.tncontent+'</h1>['+data.ukmark+']<h5 style="font-size:0.5em;color:gray;">'+data.morphology+data.cncontent+'</h5>';
		}else{
			content=content+'<h1 style="font-size:2.0em;color:black;">'+data.tncontent+'</h1><h5 style="font-size:0.5em;color:gray;">'+data.morphology+data.cncontent+'</h5>';
		}
		
		content=content+'<img style="margin-top:10px;" width="200px" height="150px" src="'+resource+'/pic_word/'+data.pic+'">';
		content=content+'</div>';
	}else if(type==3){
		content=content+'<div class="title over" style="margin-top:30%;font-family: times;color:black;text-align:center;">';
		content=content+'<h3 style="margin-left:10px;width:90%;margin-right:15px;font-size:1.0em;color:black;">'+data.tncontent+'</h3>';
		content=content+'<h5 style="font-size:1.0em;color:gray;margin-top:20px;margin-left:10px;margin-right:15px;width:90%;">'+data.cncontent+'</h5>';
		content=content+'</div>';
	}
	...
	content=content+'<p style="width:33%;" class="mp3voice" mp3="'+data.usermp3+'" contentid="'+data.contentid+'" tncontent="'+data.tncontent+'" type="'+type+'" readid="'+data.readid+'"><a class="btn-bo02-on bo01 edi-yuan"><i class="fa fa-volume-up fa-18"></i></a></p>';
	content=content+'<p style="width:33%;" class="" mp3="'+data.usermp3+'"><a class="btn-bo02 bo01 edi-yuan"><i class="fa fa-music fa-18"></i></a></p>';
	if(issubmit==0){
		content=content+'<p style="width:33%;" class="micro" mp3="'+data.usermp3+'"><a class="btn-bo02 bo01 edi-yuan"><i class="fa fa-microphone fa-18"></i></a></p>';
	}else{
...
// //进行一个模块的展示
// .ttip {background-color:#333; display:block; position:absolute; top: 0; left:0; color:#fff;  opacity:0.7; width:100%; display:none; box-shadow: 1px 1px 5px #555; text-align:center; z-index:1000;}
// .ttip-wz { position:absolute; color:#fff; top: 40%; padding: 0 30px; z-index: 1001; font-size: 1.2em; line-height: 2em;;}
// -----------------html部分-------------
// <div class="ttip"></div>
// <div class="ttip-wz"></div>
// -------------------js部分------------------
// $(function(){
// 	$("**").click(function(){
// 		$(".ttip-wz").html("单词跟读已完成，下面将开始单词拼写作业");
// 		$('.ttip').css('height',$(window).height());
// 		$(".ttip,.ttip-wz").fadeIn(300).delay(3000).fadeOut(300); 
//     })
// })
