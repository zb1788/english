...
//    "<li>←</li>"+
  ...
  "</ul>");    
    ...
    keyboard.children("li:eq("+10+")").mousedown(function(event){
        $(this).css({top:"0.1em","box-shadow": "inset 0 0em 0 rgba(0,0,0,.9)"});
        keyboard.children("li:eq("+10+")").css({"box-shadow": "inset 0 0.04em 0 rgba(0,0,0,.9)"});
    })
    .mouseup(function(event){
        $(this).css({top:"0.1em","box-shadow":" inset 0 0em 0 rgba(0,0,0,.9)"});
        keyboard.children("li:eq("+10+")").css({"box-shadow":" inset 0 0em 0 rgba(0,0,0,.9)"});
    });
    }
