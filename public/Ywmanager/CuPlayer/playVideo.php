...
<strong>提示：您的Flash Player版本过低，请<a href="http://www.52player.com/">点此进行网页播放器升级</a>！</strong></div>
<script type="text/javascript">
...
so.addVariable("CuPlayerFile",decodeURI(GetQueryString("filepath"))); //视频文件地址
