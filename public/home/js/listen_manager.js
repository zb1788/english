...
function headerHtml(examsdata){
    ...
    temphtmlstr = '<div class="titleCon"><div class="fl"><h2>'+examsdata[0]['name']+'</h2><a href="javascript:;" class="playBtn none"></a></div><div class="fr  none" id="changebutton"><a  href="javascript:;" class="aBtn cur">重新测验</a><a  href="javascript:;" class="aBtn">听力材料</a></div><div class="clearfix"></div></div>';
