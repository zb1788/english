...
function Show_Tab1(num,active,where){
	for(var i=0;i<num;i++){
		if(i!=active){
			document.getElementById(where+"s_"+i).style.display="none";
			document.getElementById(where+"Tab_"+i).className="";
...
/*教学分析*/
$("#cy_cs").bind("mouseover",function(){
	$("#kt_rs").show();
	})
$("#cy_cs").bind("mouseleave",function(){
	$("#kt_rs").hide();
	})

$("#dx_cs").bind("mouseover",function(){
	$("#dx_rs").show();
	})
$("#dx_cs").bind("mouseleave",function(){
	$("#dx_rs").hide();
	})
	
$("#zy_cs").bind("mouseover",function(){
	$("#zy_rs").show();
	})
$("#zy_cs").bind("mouseleave",function(){
	$("#zy_rs").hide();
	})	
