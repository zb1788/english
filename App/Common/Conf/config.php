<?php
return array(
    'MODULE_ALLOW_LIST' => array('Home', 'Mobile','Klx','Homework','Pubinterface','Manager','Subject','Yuwen','Shuxue','Elearn','ywmanager','Elearnmanager','Sdfree','Error'),
    'DEFAULT_MODULE' => 'Home',
    //数据库配置信息
    'DB_TYPE' => 'mysql', // 数据库类型
   // 'DB_HOST' => '192.168.148.106', // 服务器地址
    ...
    'URL_ROUTE_RULES'=>array(
		...
		'/^Subject\/dojumpurl(.*)$/' => 'Subject/Index/dojumpurl',
    ),
