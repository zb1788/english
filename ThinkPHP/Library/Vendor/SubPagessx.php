...
function subPageCss2(){   
   $subPageCss2Str="";   
    ...
    $subPageCss2Str.='<a style="color:#ccc;">首页</a> ';   
    $subPageCss2Str.='<a style="color:#ccc;">上一页</a> ';   
    }   
   ...
   $a=$this->construct_num_Page();  
    for($i=0;$i<count($a);$i++){   
	    ...
	    if($s == $this->current_page ){   
	        $subPageCss2Str.='<a href="javascript:;" class="current" >'.$s.'</a>';   
	     }else{   
	     //调用查询页面的js方法pagelist()
    ...
    $subPageCss2Str.='<a style="color:#ccc;">下一页</a> ';   
    $subPageCss2Str.='<a style="color:#ccc;">尾页</a> ';   
    }  
   ...
   */
   function subPageCss3(){
	   	...
	   	if($this->current_page > 1){
	   		...
	   		$subPageCss3Str.='<a style="disabled:true;">首页</a> ';
	   		$subPageCss3Str.='<a style="disabled:ture;">上一页</a> ';
	   	}
	   	...
	   	if($this->current_page < $this->pageNums){
	   		...
	   		$subPageCss3Str.='<a style="color:#ccc;">下一页</a> ';
	   		$subPageCss3Str.='<a style="color:#ccc;">尾页</a> ';
	   	}
